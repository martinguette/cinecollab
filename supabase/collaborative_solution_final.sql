...
-- Creador: acceso completo a sus listas y películas
-- Colaboradores: solo pueden agregar y eliminar películas
...
-- Watchlists: Solo propietarios pueden ver/editar/eliminar sus propias watchlists
...
-- Watchlist_movies: 
-- - Creador: acceso completo a todas las películas de sus listas
-- - Colaboradores: solo pueden ver, agregar y eliminar películas
