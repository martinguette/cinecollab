-- SOLUCIÓN COLABORATIVA DESDE CERO
-- Este script elimina TODAS las políticas existentes y crea las nuevas
...
-- 6. ELIMINAR TODAS LAS POLÍTICAS EXISTENTES (INCLUYENDO LAS NUEVAS)
...
-- 7. ELIMINAR TAMBIÉN LAS POLÍTICAS ANTIGUAS POR SI ACASO
...
-- 9. CREAR POLÍTICAS COLABORATIVAS SIN RECURSIÓN
