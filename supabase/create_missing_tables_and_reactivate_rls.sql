-- CREAR TABLAS FALTANTES Y REACTIVAR RLS
-- Este script crea las tablas user_favorites y user_watched, y reactiva RLS
...
-- 3. CREAR POLÍTICAS RLS CORRECTAS (SIN RECURSIÓN)
